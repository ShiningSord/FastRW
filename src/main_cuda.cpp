...
int main(int argc, char** argv) {
    ...
    std::cerr << "Experimental Windows/CUDA backend: not rigorously tested by the project maintainers; "
                 "for reference only.\n";
    // Keep experimental samples separate from the reference reproduction outputs.
    config.output.directory /= "cuda-experimental";
